...
// -----------------------------------
// SMBIOS Protocol and Structures
// -----------------------------------
...
#define SMBIOS_TYPE_MEMORY_CONTROLLER_INFO   5
#define SMBIOS_TYPE_MEMORY_MODULE_INFO       6
#define SMBIOS_TYPE_CACHE_INFORMATION        7
#define SMBIOS_TYPE_PORT_CONNECTOR_INFO      8
#define SMBIOS_TYPE_SYSTEM_SLOTS             9
#define SMBIOS_TYPE_ONBOARD_DEVICE_INFO      10
#define SMBIOS_TYPE_OEM_STRINGS              11
#define SMBIOS_TYPE_SYSTEM_CONFIG_OPTIONS    12
#define SMBIOS_TYPE_BIOS_LANGUAGE_INFO       13
...
#define SMBIOS_TYPE_64BIT_MEMORY_ERROR_INFO  33
#define SMBIOS_TYPE_MANAGEMENT_DEVICE        34
#define SMBIOS_TYPE_MANAGEMENT_DEVICE_COMPONENT 35
#define SMBIOS_TYPE_MANAGEMENT_DEVICE_THRESHOLD 36
...
#define SMBIOS_TYPE_ONBOARD_DEVICES_EXTENDED 41
#define SMBIOS_TYPE_MANAGEMENT_CONTROLLER_HOST 42
...
typedef struct {
    ...
    UINT8         SKUNumber;
    UINT8         Family;
} SMBIOS_TYPE1_SYSTEM_INFORMATION;
...
typedef struct {
    ...
    UINT8         SBDSVersionNumber;
    UINT8         MaximumErrorInBatteryData;
    UINT16        SBDSSerialNumber;
    UINT16        SBDSManufactureDate;
    UINT8         SBDSDeviceChemistry;
    UINT8         DesignCapacityMultiplier;
    UINT32        OEMSpecific;
} SMBIOS_TYPE22_PORTABLE_BATTERY;

// EFI_SMBIOS_PROTOCOL
typedef struct EFI_SMBIOS_PROTOCOL EFI_SMBIOS_PROTOCOL;

typedef UINT16 EFI_SMBIOS_HANDLE;
typedef UINT8  EFI_SMBIOS_TYPE;
typedef SMBIOS_HEADER EFI_SMBIOS_TABLE_HEADER;
...
typedef
EFI_STATUS
(EFIAPI *EFI_PCI_IO_PROTOCOL_CONFIG_READ) (
...
typedef
EFI_STATUS
(EFIAPI *EFI_PCI_IO_PROTOCOL_CONFIG_WRITE) (
    IN EFI_PCI_IO_PROTOCOL        *This,
    IN EFI_PCI_IO_PROTOCOL_WIDTH  Width,
    IN UINT32                     Offset,
    IN UINTN                      Count,
...
typedef struct {
    ...
    EFI_PCI_IO_PROTOCOL_CONFIG_WRITE Write;
